...
---
__VIGNETTE UNDER CONSTRUCTION__  
We are updating the class definition for mgFeatures to contain a DataFrame class object instead of a AnnotatedDataFrame class object. 
This will allow for mgFeatures to define the rowData of a summarizedExperiment class object, used by curratedMetagenomeData, but not eSet objects which MRexperiment-objects currently extend. 
We are planning to convert MRexperiment-objects to summerizedExperiment class objects.
...
### annotateMRexp_fData
__This no longer works with new mgFeature class definition__
