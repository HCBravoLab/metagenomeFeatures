...
# Vignette overview
16S rRNA reference databases are most often used to annotate OTUs or sequence variants from experimental datasets. 
The reference databases can also be used to study the diversity of specific taxonomic groups. 
...
We will first load the `MgDb-class` object, then select the taxa of interest, and finally explore the phylogenetic, and taxonomic composition of the _Gammaproteobaceria_ class. 
