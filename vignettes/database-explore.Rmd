...
As this database is preclustered to 85\% similarity OTUs per genus is more of an indicator of genera diversity than how well the genera is represented in the database. 
